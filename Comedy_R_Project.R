# Nancy Kirkman
#MDST 3490 Comedy Final Project R Script 
...
# Starting back up again on a different clip --- 'Going out while broke' or something like that
...
# this one is gulman "The Great Depresh" 
...
# Hannah Gadsby Nannette --> Hannah Gadsby Compares Lesbians to Unicorn 
...
# ONE LAST GARY clip then we'll go to bed (It's 1:51 am)]
# The Gul Takes on the Old Testament 
